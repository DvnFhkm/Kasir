...
<div class="row">
    ...
    <div class="col-md-3 mb-3">
        <div class="card">
            <div class="card-header bg-primary text-white">
                <h6 class="pt-2"><i class="fas fa-cubes"></i> Jumlah Menu</h6>
            </div>
            <div class="card-body">
                <center>
    ...
    <div class="col-md-3 mb-3">
        <div class="card">
            <div class="card-header bg-primary text-white">
                <h6 class="pt-2"><i class="fas fa-chart-bar"></i> Stok Makanan dan Minuman</h6>
            </div>
            <div class="card-body">
                <center>
    ...
    <div class="col-md-3 mb-3">
        <div class="card">
            <div class="card-header bg-primary text-white">
                <h6 class="pt-2"><i class="fa fa-bookmark"></i> Kategori </h6>
            </div>
            <div class="card-body">
                <center>
