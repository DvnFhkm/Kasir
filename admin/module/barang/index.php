        ...
        if ($r > 0) {
            echo "
				<div class='alert alert-warning'>
					<span class='glyphicon glyphicon-info-sign'></span> Ada <span style='color:red'>$r</span> barang yang Stok tersisa sudah kurang dari 3 items. silahkan restok lagi !!
                                ...
                                <td>
                                    ...
                                    <?php } else { ?>
                                        <a href="index.php?page=barang/details&barang=<?php echo $isi['id_barang']; ?>"><button
                                                class="btn btn-primary btn-xs"><i class="fa-solid fa-circle-info"></i></button></a>

                                        <a href="index.php?page=barang/edit&barang=<?php echo $isi['id_barang']; ?>"><button
                                                class="btn btn-warning btn-xs"><i class="fa-solid fa-pen"></i></button></a>
                                        <a href="fungsi/hapus/hapus.php?barang=hapus&id=<?php echo $isi['id_barang']; ?>"
                                            onclick="javascript:return confirm('Hapus Data barang ?');"><button
                                                class="btn btn-danger btn-xs"><i class="fa-solid fa-trash-can"></i></button></a>
                                    <?php } ?>
                            </tr>
                        <?php
                            $no++;
                    ...
                    <form action="fungsi/tambah/tambah.php?barang=tambah" method="POST">
                        <div class="modal-body">
                            <table class="table table-striped bordered">
                                ...
                                <tr>
                                    <td>Harga Modal</td>
                                    <td><input type="number" placeholder="Harga modal" required class="form-control"
                                            name="beli" autocomplete="off"></td>
                                </tr>
                                <tr>
                                    <td>Harga Jual</td>
                                    <td><input type="number" placeholder="Harga Jual" required class="form-control"
                                            name="jual" autocomplete="off"></td>
                                </tr>
                                <!-- <tr>
                                    <td>Satuan Barang</td>
                                    <td>
